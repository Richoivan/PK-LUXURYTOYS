        ...
        <div id="brandsCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 justify-content-center align-items-center g-3 g-md-4">
                        @foreach($manufacturerChunk as $loopIndex => $manufacturer)
                        <div class="col {{ $loopIndex > 0 ? 'd-none d-sm-block' : '' }} {{ $loopIndex > 1 ? 'd-none d-md-block' : '' }} {{ $loopIndex > 3 ? 'd-none d-lg-block' : '' }}">
                            <div class="card brand-card h-100 border-0 shadow-sm">
                                <div class="card-body text-center p-3 p-md-4">
                                    <img src="{{ asset('storage/brands/' . strtolower(str_replace(' ', '-', $manufacturer->name)) . '.png') }}" 
                                         alt="{{ $manufacturer->name }}" class="img-fluid brand-logo mb-2 mb-md-3" 
                                         style="max-height: 60px;" 
                                         onerror="this.src='{{ asset('storage/brands/default-brand.png') }}'">
    ...
    <div class="container">
        ...
        <div id="carTypesCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 justify-content-center align-items-center g-3 g-md-4">
                        @foreach($carTypeChunk as $loopIndex => $carType)
                        <div class="col {{ $loopIndex > 0 ? 'd-none d-sm-block' : '' }} {{ $loopIndex > 1 ? 'd-none d-md-block' : '' }} {{ $loopIndex > 3 ? 'd-none d-lg-block' : '' }}">
                            <div class="card brand-card h-100 border-0 shadow-sm">
                                <div class="card-body text-center p-3 p-md-4">
                                    <img src="{{ asset('storage/car-types/' . strtolower(str_replace(' ', '-', $carType->name)) . '.png') }}" 
                                         alt="{{ $carType->name }}" class="img-fluid mb-2 mb-md-3" 
                                         style="max-height: 60px;"
                                         onerror="this.src='{{ asset('storage/car-types/default-type.png') }}'">
