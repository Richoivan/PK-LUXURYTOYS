      ...
      <div class="col-md-8 d-flex justify-content-center align-items-center bg-white">
        <div class="border rounded-4 shadow p-5" style="max-width: 480px; width: 100%;">
          ...
          <form method="GET" action="{{route('admin.login')}}">
            ...
            <div class="mb-3">
              <label for="password" class="form-label small">Enter Your New Password</label>
              <input type="password" name="new_password" id="new_password" class="form-control" required autofocus>
            </div>

            <div class="mb-3">
              <label for="new_password" class="form-label small">Re-Enter Your New Password</label>
              <input type="password" name="new_password" id="new_password" class="form-control" required>
            </div>

            <button type="submit" class="btn btn-dark fw-bold w-100 rounded-pill mb-3">CHANGE PASSWORD</button>
